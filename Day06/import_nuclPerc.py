        ...
        for chrom in ref_genome.references:
            ...
            for pileupcolumn in bam_file.pileup(chrom):
                ...
                result = {
                    ...
                    'A_perc': round((base_counts['A'] / total_coverage * 100), 2) if total_coverage > 0 else 0,
                    'C_perc': round((base_counts['C'] / total_coverage * 100), 2) if total_coverage > 0 else 0,
                    'G_perc': round((base_counts['G'] / total_coverage * 100), 2) if total_coverage > 0 else 0,
                    'T_perc': round((base_counts['T'] / total_coverage * 100), 2) if total_coverage > 0 else 0,
                    'Del_perc': round((base_counts['Del'] / total_coverage * 100), 2) if total_coverage > 0 else 0,
                    'Ins_perc': round((base_counts['Ins'] / total_coverage * 100), 2) if total_coverage > 0 else 0
                }
